...
summary(empdata)
str(empdata)
#empdata$MonthlyRate<-scale(log(empdata$MonthlyRate))
#empdata$MonthlyIncome<-scale(empdata$MonthlyIncome)
#empdata$DailyRate<-scale(empdata$DailyRate)
#empdata[,c(1,4,6,11,17,18)]<-scale(empdata[,c(1,4,6,11,17,18)])
#empdata[,c(21,24,25,26)]<-scale(empdata[,c(21,24,25,26)])
#empdata[,c(28,29,30,31)]<-scale(empdata[,c(28,29,30,31)])
